...
namespace Ramune.CustomizableLights
{
    ...
    {
        [Slider("<color=#ffbd2e>Seaglide</color> Light Red (R)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 30), OnChange(nameof(SeaglideOnColorChange))]
        public float SeaglideRed = 1f;

        [Slider("<color=#ffbd2e>Seaglide</color> Light Green (G)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 31), OnChange(nameof(SeaglideOnColorChange))]
        public float SeaglideGreen = 1f;

        [Slider("<color=#ffbd2e>Seaglide</color> Light Blue (B)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 32), OnChange(nameof(SeaglideOnColorChange))]
        public float SeaglideBlue = 1f;

        [Slider("<color=#ffbd2e>Seaglide</color> Light Range Multiplier (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 33), OnChange(nameof(SeaglideOnSettingsChange))]
        public float SeaglideRange = 1f;

        [Slider("<color=#ffbd2e>Seaglide</color> Light Intensity Multiplier (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 34), OnChange(nameof(SeaglideOnSettingsChange))]
        public float SeaglideIntensity = 1f;

        [Slider("<color=#ffbd2e>Seaglide</color> Light Cone Size Multipler (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 35), OnChange(nameof(SeaglideOnSettingsChange))]
