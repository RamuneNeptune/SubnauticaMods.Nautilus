...
namespace Ramune.CustomizableLights
{
    ...
    {
        [Slider("<color=#ffbd2e>Cyclops</color> Light Red (R)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 16), OnChange(nameof(CyclopsOnColorChange))]
        public float CyclopsRed = 1f;

        [Slider("<color=#ffbd2e>Cyclops</color> Light Green (G)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 17), OnChange(nameof(CyclopsOnColorChange))]
        public float CyclopsGreen = 1f;

        [Slider("<color=#ffbd2e>Cyclops</color> Light Blue (B)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 18), OnChange(nameof(CyclopsOnColorChange))]
        public float CyclopsBlue = 1f;

        [Slider("<color=#ffbd2e>Cyclops</color> Light Range Multiplier (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 19), OnChange(nameof(CyclopsOnSettingsChange))]
        public float CyclopsRange = 1f;

        [Slider("<color=#ffbd2e>Cyclops</color> Light Intensity Multiplier (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 20), OnChange(nameof(CyclopsOnSettingsChange))]
        public float CyclopsIntensity = 1f;

        [Slider("<color=#ffbd2e>Cyclops</color> Light Cone Size Multipler (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 21), OnChange(nameof(CyclopsOnSettingsChange))]
