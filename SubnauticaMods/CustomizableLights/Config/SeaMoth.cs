...
namespace Ramune.CustomizableLights
{
    ...
    {
        [Slider("<color=#ffbd2e>Seamoth</color> Light Red (R)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 1), OnChange(nameof(SeamothOnColorChange))]
        public float SeamothRed = 1f;

        [Slider("<color=#ffbd2e>Seamoth</color> Light Green (G)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 2), OnChange(nameof(SeamothOnColorChange))]
        public float SeamothGreen = 1f;

        [Slider("<color=#ffbd2e>Seamoth</color> Light Blue (B)", Format = "{0:F1}", DefaultValue = 1f, Min = 0f, Max = 1f, Step = 0.1f, Order = 3), OnChange(nameof(SeamothOnColorChange))]
        public float SeamothBlue = 1f;

        [Slider("<color=#ffbd2e>Seamoth</color> Light Range Multiplier (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 4), OnChange(nameof(SeamothOnSettingsChange))]
        public float SeamothRange = 1f;

        [Slider("<color=#ffbd2e>Seamoth</color> Light Intensity Multiplier (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 5), OnChange(nameof(SeamothOnSettingsChange))]
        public float SeamothIntensity = 1f;

        [Slider("<color=#ffbd2e>Seamoth</color> Light Cone Size Multipler (x)", Format = "{0:0.0}x", DefaultValue = 1f, Min = 0f, Max = 5f, Step = 0.1f, Order = 6), OnChange(nameof(SeamothOnSettingsChange))]
